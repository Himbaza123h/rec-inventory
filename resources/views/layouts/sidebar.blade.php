        ...
        <div id="sidebar-menu">
            @if (Auth::user()->role == 'admin')
                <ul>
                    ...
                    <li class="">
                        <a href="categories" class="waves-effect waves-light "><i
                                class="ion-document"></i><span>Categories</span></a>
                    </li>
                    <li class="">
                        <a href="list" class="waves-effect waves-light "><i
                                class="ion-bag"></i><span>Items</span></a>
                    </li>
                    <li class="">
                        <a href="purchase" class="waves-effect waves-light "><i
                                class="ion-ios7-pulse-strong"></i><span>Purchase</span></a>
                    </li>
                    <li class="">
                        <a href="adminstock" class="waves-effect waves-light "><i
                    ...
                    <li class="has_sub">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li><a href="supplier" class="waves-effect waves-light"><i
                                        class="ion-android-social"></i>Supplier</a></li>
                    ...
                    <li class="has_sub">
                        <a href="reports" class="waves-effect waves-light"><i
